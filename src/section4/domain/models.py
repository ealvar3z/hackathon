"""Core section4 domain enums and shared types."""
...
class ArtifactKind(StrEnum):
    """Types of artifact files or references attached to section4 records."""
...
class EventKind(StrEnum):
    """Audit and workflow events emitted by section4."""
