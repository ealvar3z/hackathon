...
from section4.domain.models import CapabilityType, EventActorType, EventKind
from section4.storage.tables import Capability, Event
from section4.transport.cot import ParsedCoTEvent


def record_received_cot(session: Session, parsed: ParsedCoTEvent) -> Event:
    """Persist a received CoT event into the section4 audit log."""
    ...
    event = Event(
        ...
        payload_json={
            ...
            "lon": parsed.lon,
            "how": parsed.how,
            "section4": parsed.detail_attributes,
...
def record_published_cot(
    ...
    *,
    ...
    """Persist a locally published CoT event into the section4 audit log."""
...
def upsert_capability_from_cot(
    ...
    """Upsert a capability from a section4 capability CoT event."""
